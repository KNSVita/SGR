    ...
    if request.method == 'POST':
        try:
            ...
            for index, row in df.iterrows():
                ...
                nota_final_calculada = nota_final_trab + nota_av_ponderada + sobra_trab
                
                nota_final_calculada = min(nota_final_calculada, 10)
...
def ver_ranking(id_classificacao):
    try:
        ...
        lista_para_ordenar = [aluno.to_dict() for aluno in alunos_do_banco]
